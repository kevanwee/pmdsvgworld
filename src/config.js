...
export const POKEMON_DEFS = {
  MEGA_DIANCIE: {
    ...
    animations: {
      ...
      strike: spriteUrl('0719', 'Strike', false, '0001'),
  ...
  SHINY_CERULEDGE: {
    ...
    animations: {
      ...
      strike: spriteUrl('0937', 'Strike', true),
  ...
  SHINY_IRON_VALIANT: {
    ...
    animations: {
      ...
      strike: spriteUrl('1006', 'Attack', true),
  ...
  SHINY_GRENINJA: {
    ...
    animations: {
      ...
      strike: spriteUrl('0658', 'QuickStrike',true),
  ...
  SHINY_ARMAROUGE: {
    ...
    animations: {
      ...
      strike: spriteUrl('0936', 'Strike', true),
  ...
  SHINY_YVELTAL: {
    ...
    animations: {
      ...
      strike: spriteUrl('0717', 'Attack', true),
